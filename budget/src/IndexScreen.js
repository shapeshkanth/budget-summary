...
const predefinedColors = [
  ...
  'gold', 'peach', 'coral', 'indigo', 'violet', 'chocolate', 'salmon', 'plum', 'orchid', 'crimson'
];
...
const IndexScreen = () => (
  ...
  >
    ...
    <Drawer.Screen name="Income" component={income} options={{ title: 'Income' }} />
    <Drawer.Screen name="Today Expenses" component={expense} options={{ title: 'Today Expenses' }} />
    <Drawer.Screen name="Graph" component={graph} options={{ title: 'Graph' }} />
    <Drawer.Screen name="Summary" component={summary} options={{ title: 'Summary' }} />
...
const Home = () => {
  ...
  const calculateProgress = (amount, totalIncome) => (amount / totalIncome) * 100;
            ...
            renderItem={({ item, index }) => (
              <View style={styles.proback}>
                ...
                <ProgressBar
                  ...
                  color={index < 30 ? predefinedColors[index] : data[index].color}
                />
              </View>
            )}
          />
